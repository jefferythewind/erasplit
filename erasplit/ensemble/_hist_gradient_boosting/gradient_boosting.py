...
from .era_grower import EraTreeGrower
...
class HistGradientBoostingRegressor(RegressorMixin, BaseHistGradientBoosting):
    ...
    :class:`GradientBoostingRegressor<erasplit.ensemble.GradientBoostingRegressor>`
    ...
    erasplit.tree.DecisionTreeRegressor : A decision tree regressor.
    ...
    Examples
    --------
    >>> from erasplit.ensemble import HistGradientBoostingRegressor
    >>> from erasplit.datasets import load_diabetes
...
class HistGradientBoostingClassifier(ClassifierMixin, BaseHistGradientBoosting):
    ...
    This estimator is much faster than
    :class:`GradientBoostingClassifier<erasplit.ensemble.GradientBoostingClassifier>`
    for big datasets (n_samples >= 10 000).
    ...
    GradientBoostingClassifier : Exact gradient boosting method that does not
        scale as good on datasets with a large number of samples.
    erasplit.tree.DecisionTreeClassifier : A decision tree classifier.
    ...
    >>> from erasplit.datasets import load_iris
...
class BaseEraHistGradientBoosting(BaseEstimator, ABC):
    """Base class for histogram-based gradient boosting estimators."""
    ...
    def fit(self, X, y, eras, sample_weight=None):
        """Fit the gradient boosting model.
...
class EraHistGradientBoostingRegressor(RegressorMixin, BaseEraHistGradientBoosting):
    """Histogram-based Gradient Boosting Regression Tree.
    ...
    _parameter_constraints: dict = {
        **BaseEraHistGradientBoosting._parameter_constraints,
        "loss": [
            StrOptions(
                {
                    "squared_error",
